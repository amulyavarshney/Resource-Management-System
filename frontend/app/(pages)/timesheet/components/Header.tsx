	...
	return (
		<header className="w-full">
			<div className="flex justify-between items-center">
				<div className="px-9 sm:px-40"></div>
				<button
					onClick={() => setShowUserData(!showUserData)}
					className="inline-flex justify-center items-center gap-2 cursor-pointer"
				>
					<h3 className="p-2 text-xl font-medium text-indigo-700 hover:text-indigo-800 dark:text-gray-300 dark:hover:text-gray-200 hover:font-bold">
