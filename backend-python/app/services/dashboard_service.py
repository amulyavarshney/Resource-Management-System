...
class DashboardService:
    ...
    async def get_lock(self, department: Department | None, region: Region | None) -> bool:
        # In-memory distributed cache is not available — this always returns False.
        # A real deployment should swap this for Redis via `fastapi-cache` or similar.
        return False

    async def set_lock(self, is_locked: bool, department: Department | None, region: Region | None) -> None:
        pass  # same as above — implement with Redis for production
